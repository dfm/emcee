...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__acor

#else
#  define SWIG_init    init_acor

#endif
#define SWIG_name    "_acor"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_acor_dfm(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:acor_dfm",&obj0)) SWIG_fail;
  {
  ...
  result = (double)acor_dfm(arg1,arg2);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"acor_dfm", _wrap_acor_dfm, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
