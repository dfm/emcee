...
(there are theorems about this for specific problems; RTFL; DFM:
Please replace the ``RTFL'' with a citation for that 0.26 number that
is out there, with a ``for example'' in front of it).  In principle,
